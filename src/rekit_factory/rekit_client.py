...
class ToolManifest:
    ...
    def public_dict(self) -> dict[str, Any]:
        return {
            ...
            "required_interactive": self.required_interactive,
...
def _synthetic_source_digest(manifest: ToolManifest,
    ...
    item = {
        ...
        "worker_requirements": {
            "platform": manifest.required_platform,
            "architecture": manifest.required_architecture,
            "isolation": manifest.required_isolation,
            "interactive": manifest.required_interactive,
            "remote": manifest.requires_remote,
        },
        "legacy": legacy,
    }
